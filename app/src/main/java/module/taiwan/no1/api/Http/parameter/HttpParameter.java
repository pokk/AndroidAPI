...
{
    private HttpConstant.apiMethod requestType;
     ...
     */
    public HttpParameter(Integer id, HttpConstant.apiMethod requestType, StringEntity entity, String url, String params, Map<String, String> header)
    {
        super(id);
     ...
     * @return request type
     */
    public HttpConstant.apiMethod getRequestType()
    {
        return requestType;
    }
     ...
     */
    public void setRequestType(HttpConstant.apiMethod requestType)
    {
        this.requestType = requestType;
    }
