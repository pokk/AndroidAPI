package module.taiwan.no1.api.Http.constanct;
...
public interface HttpConstant
{
    ...
    String KEY_SYNC = "synchronization";

    /* http bundle parameter */

    String KEY_HTTP_TYPE = "http_request_type";
    String KEY_PARAMETER_OBJECT = "http_parameter_object";

    /* http header language */

    String HEADER_LANG_TW = "zh-TW";
    String HEADER_LANG_EN = "en-US";
    String HEADER_LANG_HANT = "zh-Hant";

    /* http mark */

    String HTTP_QUERY_SEP = "?";
}
